<svg class="d-none" aria-hidden="true">
  ...
  <symbol id="icon-position" viewBox="0 0 16 16" fill="currentColor">
  ...
  <symbol id="icon-user-circle" viewBox="0 0 16 16" fill="currentColor">
  ...
  <symbol id="icon-email" viewBox="0 0 16 16" fill="currentColor">
