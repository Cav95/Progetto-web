...
function buildCard(id, date, time, location) {
  return `
    <div class="card mb-3 px-2 bg-dark text-white">
      <div class="card-body d-flex align-items-center gap-5">
        ...
        <div class="d-flex align-items-center gap-2 ms-auto">
          <button class="btn btn-danger" id="disdici-${id}">Disdici appuntamento</button>
        </div>
      </div>
    </div>
  `
